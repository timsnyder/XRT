...
elseif (${LINUX_FLAVOR} MATCHES "^(RedHat|CentOS|Amazon|Fedora|SUSE)")
  ...
  if (DEFINED ENV{CONDA_BUILD})
      ...
      set(CPACK_COMPONENTS_ALL "system")
      SET(CPACK_DEBIAN_SYSTEM_PACKAGE_NAME "xrt")
      SET(CPACK_RPM_SYSTEM_PACKAGE_NAME "xrt")
      set(CPACK_RPM_SYSTEM_PACKAGE_ARCHITECTURE "noarch")
      set(CPACK_DEBIAN_SYSTEM_PACKAGE_ARCHITECTURE "noarch")
      SET(CPACK_GENERATOR "RPM;TGZ;DEB")
      SET(CPACK_RPM_SYSTEM_POST_INSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/postinst")
      SET(CPACK_RPM_SYSTEM_PRE_UNINSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/prerm")
      SET(CPACK_DEBIAN_SYSTEM_PACKAGE_CONTROL_EXTRA "${CMAKE_CURRENT_BINARY_DIR}/postinst;${CMAKE_CURRENT_BINARY_DIR}/prerm")
      # simplify the package filenames so that the scripts in the conda package can be simple also
